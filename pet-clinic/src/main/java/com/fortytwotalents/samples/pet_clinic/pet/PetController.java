...
public class PetController {
  ...
  public void prepareContext(final Model model) {
    model.addAttribute(
        "ownerValues",
        ownerRepository.findAll(Sort.by("id")).stream()
            .collect(CustomCollectors.toSortedMap(Owner::getId, Owner::getId)));
    model.addAttribute(
        "typeValues",
        typeRepository.findAll(Sort.by("id")).stream()
  ...
  @PostMapping("/add")
  public String add(
      @ModelAttribute("pet") @Valid final PetDTO petDTO,
    ...
    redirectAttributes.addFlashAttribute(
        WebUtils.MSG_SUCCESS, WebUtils.getMessage("pet.create.success"));
  ...
  public String edit(
    ...
    redirectAttributes.addFlashAttribute(
        WebUtils.MSG_SUCCESS, WebUtils.getMessage("pet.update.success"));
    return "redirect:/pets";
  }
  ...
  public String delete(
    ...
    if (referencedWarning != null) {
      ...
      redirectAttributes.addFlashAttribute(
          WebUtils.MSG_INFO, WebUtils.getMessage("pet.delete.success"));
    }
    return "redirect:/pets";
  }
}
