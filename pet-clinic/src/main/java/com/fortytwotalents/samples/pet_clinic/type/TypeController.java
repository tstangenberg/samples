...
public class TypeController {
  ...
  @PostMapping("/add")
  public String add(
      @ModelAttribute("type") @Valid final TypeDTO typeDTO,
    ...
    redirectAttributes.addFlashAttribute(
        WebUtils.MSG_SUCCESS, WebUtils.getMessage("type.create.success"));
  ...
  public String edit(
    ...
    redirectAttributes.addFlashAttribute(
        WebUtils.MSG_SUCCESS, WebUtils.getMessage("type.update.success"));
    return "redirect:/types";
  }
  ...
  public String delete(
    ...
    if (referencedWarning != null) {
      ...
      redirectAttributes.addFlashAttribute(
          WebUtils.MSG_INFO, WebUtils.getMessage("type.delete.success"));
    }
    return "redirect:/types";
  }
}
