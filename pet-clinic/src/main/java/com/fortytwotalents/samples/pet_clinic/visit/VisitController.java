...
public class VisitController {
  ...
  public void prepareContext(final Model model) {
    model.addAttribute(
        "petValues",
        petRepository.findAll(Sort.by("id")).stream()
  ...
  public String add(
    ...
    redirectAttributes.addFlashAttribute(
        WebUtils.MSG_SUCCESS, WebUtils.getMessage("visit.create.success"));
  ...
  public String edit(
    ...
    redirectAttributes.addFlashAttribute(
        WebUtils.MSG_SUCCESS, WebUtils.getMessage("visit.update.success"));
    return "redirect:/visits";
  }
  ...
  public String delete(
    ...
    redirectAttributes.addFlashAttribute(
        WebUtils.MSG_INFO, WebUtils.getMessage("visit.delete.success"));
    return "redirect:/visits";
  }
}
