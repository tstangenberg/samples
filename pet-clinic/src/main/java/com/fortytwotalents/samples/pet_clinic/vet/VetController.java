...
public class VetController {
  ...
  public VetController(final VetService vetService, final SpecialtyRepository specialtyRepository) {
  ...
  public void prepareContext(final Model model) {
    model.addAttribute(
        "vetSpecialtySpecialtiesValues",
        specialtyRepository.findAll(Sort.by("id")).stream()
  ...
  @PostMapping("/add")
  public String add(
      @ModelAttribute("vet") @Valid final VetDTO vetDTO,
    ...
    redirectAttributes.addFlashAttribute(
        WebUtils.MSG_SUCCESS, WebUtils.getMessage("vet.create.success"));
  ...
  public String edit(
    ...
    redirectAttributes.addFlashAttribute(
        WebUtils.MSG_SUCCESS, WebUtils.getMessage("vet.update.success"));
    return "redirect:/vets";
  }
  ...
  public String delete(
    ...
    redirectAttributes.addFlashAttribute(
        WebUtils.MSG_INFO, WebUtils.getMessage("vet.delete.success"));
    return "redirect:/vets";
  }
}
